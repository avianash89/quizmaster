  ...
  return (
    <dialog id="my_modal_3" className="modal">
      ...
      >
        {/* Close Button */}
        <form method="dialog">
          <button className="btn btn-sm btn-circle btn-ghost absolute right-4 top-4 text-white hover:text-red-400">
            ✕
          </button>
        </form>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-white/20 
              text-white placeholder-gray-300 outline-none backdrop-blur-md border border-white/30 
              focus:border-pink-500 focus:ring-2 focus:ring-pink-400 transition"
            />
            {errors.username && (
          ...
          <div className="flex flex-col relative">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-white/20 
              text-white placeholder-gray-300 outline-none backdrop-blur-md border border-white/30 
              focus:border-blue-500 focus:ring-2 focus:ring-blue-400 pr-12"
            />
            <button
              type="button"
          ...
          <button
            type="submit"
            className="w-full py-2.5 rounded-xl bg-gradient-to-r from-pink-500 to-purple-600 
            text-white font-semibold text-lg shadow-lg shadow-pink-500/30 
